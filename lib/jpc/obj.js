...
export default class BaseProtocol {
   ...
   *
   * @param classDescrJSON {object} Describes the remote class, see PROTOCOL.md
   ...
   *
   * @param objDescrJSON {object} Describes the remote object, see PROTOCOL.md
   ...
   * @returns {object} Object description, see PROTOCOL.md
   */
