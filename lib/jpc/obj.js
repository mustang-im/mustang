...
import { Buffer } from "buffer"; // TODO Use node built-in "buffer" for node.js and npm "buffer" for browser. Tell vite to use npm package for renderer, in electron.vite.config.js
