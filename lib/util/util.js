 ...
 */
export function mixInto(source, target) {
 ...
 * @returns {Abortable}
 */
export function runAsync(func, errorCallback, delay) {
 ...
 * @returns {Abortable}
 */
export function runPeriodically(func, errorCallback, interval) {
 ...
 */
export function objForEach(obj, callback, self) {
  for (var key in obj) {
 ...
 */
export function readURLasUTF8(url) {
...
export class ImplementThis extends Exception {
}
 ...
 * in a uniform way.
 */
export class TimeoutAbortable extends Abortable {
  /**
 ...
 * in a uniform way.
 */
export class IntervalAbortable extends Abortable {
  /**
 ...
 */
export class SuccessiveAbortable extends Abortable {
  constructor() {
    super();
    this._current = null;
  }
 ...
 */
export class PromiseAbortable extends Abortable {
 ...
 */
export class ControllerAbortable extends Abortable {
  constructor() {
    super();
 ...
 */
export function errorInBackend(e) {
