...
import { getAppDir } from "./util"; // ours
import { promisify } from "util"; // node.js
import fs from "fs";
...
export async function prefsDir() {
...
let gPrefs = null;
let gDefaultPrefs = null;
let gUserPrefs = new Preferences("");

export let pref = gUserPrefs;
export let myPrefs = gUserPrefs;
export let ourPref = gUserPrefs;
export let obj = gPrefs;
