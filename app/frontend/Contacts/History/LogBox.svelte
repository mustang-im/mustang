<hbox class="left" />
<LogTime {message} {previousMessage} />
...
<script lang="ts">
  ...
  import LogTime from "./LogTime.svelte";
  import LogIconByType from "./LogIconByType.svelte";
  import LogContentByType from "./LogContentByType.svelte";
