...
import { ActiveSyncFolder, FolderType, ensureArray } from "./ActiveSyncFolder";
...
export class ActiveSyncAccount extends MailAccount {
  ...
  readonly folderMap = new Map<string, ActiveSyncFolder>;
  ...
  async callEAS(aCommand: string, aRequest: any): Promise<any> {
