...
export class OWAPerson extends Person {
  ...
  async saveToServer() {
    ...
    let response = await this.addressbook.account.callOWA(request, this.addressbook.mailbox);
  ...
  async deleteFromServer() {
    ...
    await this.addressbook.account.callOWA(request, this.addressbook.mailbox);
