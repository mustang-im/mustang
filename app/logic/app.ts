...
import type { AddressbookAccount } from './Contacts/AddressbookAccount';
import type { Addressbook } from './Contacts/Addressbook';
import type { CalendarAccount } from './Calendar/CalendarAccount';
...
class AppGlobal {
  ...
  readonly addressbookAccounts = new ArrayColl<AddressbookAccount>();
  readonly addressbooks = new ArrayColl<Addressbook>();
  readonly calendarAccounts = new ArrayColl<CalendarAccount>();
