...
import { onMessageExtracted } from "../../extractor-plugin";
	...
	const plugins: Plugin[] = [
		{
          ...
          walk(ast, {
            enter(node, _parent, _prop, _index) {
              extractTags(['$t', 'msg'], node, id, onMessageExtracted);
              extractPlurals(['$plural'], node, id, onMessageExtracted);
              extractPluralMessages(['msgPlural'], node, id, onMessageExtracted);
              extractComponent(node, id, onMessageExtracted);
            },
          });
