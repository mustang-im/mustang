...
/** The fixtures are stored with LF, but S/MIME digests the signed part with CRLF */
...
/** `openssl smime -sign`, with a self-signed certificate for alice@example.com */
const kClearSigned = `From: Alice <alice@example.com>
...
/** `openssl smime -sign -nodetach`, i.e. the message is inside the CMS blob */
const kOpaqueSigned = `From: Alice <alice@example.com>
To: User <user@example.com>
Subject: Signed test
Date: Tue, 14 Jul 2026 10:00:00 +0000
