 ...
 */
Preferences.getLocalized = function(prefName) {
  try {
    return this._prefBranch.getComplexValue(prefName, Ci.nsIPrefLocalizedString).data;
  } catch (ex) {
...
Preferences._set = function(prefName, prefValue) {
  ...
  var existingPrefType = this._prefBranch.getPrefType(prefName);
 ...
 */
Object.defineProperty(Preferences, "defaults",
{
  get: function defaults() {
    return new Preferences(({branch: this._branchStr, defaultBranch: true}));
  },
  enumerable: true,
  configurable: true
});
 ...
 */
Preferences.observeAuto = function(win, prefName, callback, thisObject) {
 ...
 * contents.childPrefNames().forEach(prefName) {
 ...
 */
Preferences.childPrefNames = function() {
  return this._prefBranch.getChildList("", []);
};
 ...
 */
Object.defineProperty(Preferences, "mozillaPrefBranch",
{
  get: function mozillaPrefBranch() {
 ...
 * @returns {String}
 */
Object.defineProperty(Preferences, "prefBranchName",
{
  get: function prefBranchName() {
    return this._branchStr;
  },
  enumerable: true,
  configurable: true
});
 ...
 * @returns {Preferences}
 */
Preferences.branch = function(subbranch) {
  return new Preferences(this._branchStr + subbranch);
},
